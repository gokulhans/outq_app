...
class _UserHomePageState extends State<UserHomePage> {
  ...
  List tabScreens = [
    ...
    // const Center(child: UserSearchServicesPage()),
        ...
        child: Container(
          child: Column(
            ...
            children: [
              ...
              addVerticalSpace(20),
              FutureBuilder(
                future: http.get(Uri.parse('${apidomain}store/store/get')),
                builder: (BuildContext context,
                    AsyncSnapshot<http.Response> snapshot) {
                  if (snapshot.hasData) {
                    var data = jsonDecode(snapshot.data!.body);
                    ...
                    return Container(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          return InkWell(
                            onTap: () {
                              Get.to(() => UserViewStorePage(), arguments: [
                                data[index]['type'],
                                data[index]['name'],
                                data[index]['start'],
                                data[index]['end']
